...
def load_model_from_config(config_path):
    ...
    if model_name == 'UNet3D' or model_name == "UNet3D-2" or model_name == "UNet3D-3":
        return UNet(
            spatial_dims=3, 
    ...
    elif model_name == 'UNETR' or model_name == 'UNETR-2' or model_name == 'UNETR-3':
        return UNETR(
            spatial_dims=3,
            in_channels=in_channels,
            out_channels=out_channels,
    ...
    elif model_name == 'VNet' or model_name == 'VNet-2' or model_name == 'VNet-3':
        return VNet(
            spatial_dims=3,
            in_channels=in_channels,
            out_channels=out_channels,
