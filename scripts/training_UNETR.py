...
from scripts.utils import save_checkpoint, log_to_mlflow, Config
...
CONFIG_FILE_PATH = "config/config_UNETR.yaml"
...
model = torch.nn.DataParallel(load_model_from_config(CONFIG_FILE_PATH)).to(device)
